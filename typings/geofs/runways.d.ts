...
declare namespace runways {
    ...
    function getNearRunways(a: number[], b?: number, c?: number): [string, number, number, number, number, number] & {distance: number};
    function setRunwayDistance(a: number[], b: ([string, number, number, number, number, number] & {distance: number})[]): void;
    function setRunwayModelVisibility(a: boolean): void;
    function getRotationCanvas(a: string): Promise<typeof env[key]>;
    function asyncSetImageLayerRotationPosition(a: string, b: number, c: number[], d: runway): Promise<void>;
    ...
    class runway {
        ...
        constructor(a: [string, number, number, number, number, number, number], b: string);
