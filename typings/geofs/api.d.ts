...
declare class LTileLayerFallback extends L.TileLayer {
    ...
    constructor(urlTemplate: string, options?: L.TileLayerOptions & {minNativeZoom: number});
}
...
declare namespace api {
    ...
    const imageryColorModifiers: {[key: string]: {
        brightness: number;
        contrast: number;
        saturation: number;
        gamma: number;
    ...
    const defaultImageryColorModifier: Readonly<typeof imageryColorModifiers[string]>;
    const atmosphereColorModifiers: {[key: string]: {
    ...
    const defaultAtmosphereColorModifier: Readonly<typeof atmosphereColorModifiers[string]>;
    ...
    let tileLayerConstructor: (urlTemplate: string, options: L.TileLayerOptions & {minNativeZoom: number}) => LTileLayerFallback;
    ...
    const toolTipPositioning: {direction: 'top' | 'right' | 'bottom' | 'left', offset: L.Point}[];
    ...
    function addFrameCallback(a: (a: number) => void, b: string, c: number): number; // a in the callback is geofs.api.precisionTime
    ...
    function setImageryProvider(a: Cesium.ImageryProvider, b: boolean, c: number, d: number, e: number): Cesium.ImageryLayer;
    ...
    function setImageryColorModifier(a: string, b: typeof api.imageryColorModifiers[string]): void;
    ...
    function setAtmosphereColorModifier(a: string, b: typeof api.atmosphereColorModifiers[string]): void;
    ...
    function addLabel(a: string, b: number[], c: Parameters<typeof labels.add>[0]): {text: string, position: Cesium.Cartesian3};
    function updateLabelText(a: {text: string, position: Cesium.Cartesian3}, b: string): void;
    function removeLabel(a: Cesium.Label): void;
    function setLabelPosition(a: {text: string, position: Cesium.Cartesian3}, b: number[]): void;

    function getGuarantiedGroundAltitude(a: number[]): Promise<[{height: number}] | Cesium.Cartographic[]>;
    ...
    function setShadowLocationRotation(a: Cesium.Model, b: number[], c: number[], d: number[]): void;

    class Model {
        constructor(a: string, b: Partial<Parameters<typeof Cesium.Model.fromGltf>[0] & {justLoad: boolean}>);
        _model: Cesium.Model;
        _opacity: number;
        _lla: number[];
    ...
    function loadModel(a: string | Parameters<typeof Cesium.Model.fromGltf>[0] & {justLoad: boolean}): Cesium.Model;
    ...
    function fromHeadingPitchRoll(a: number, b: number, c: number, d?: Cesium.Quaternion): Cesium.Quaternion;
    function headingPitchRollScaleToFixedFrame(a: Cesium.Cartesian3, b: number, c: number, d: number, e: number[]): Cesium.Matrix4;
    function getPositionOrientationAndScaleMatrix(a: number[], b?: number[], c?: number[]): Cesium.Matrix4;
    function setModelElevation(a: Cesium.Model, b: number): void;
    function setModelPositionOrientationAndScale(a: Cesium.Model, b: number[] | number, c?: number[] | number, d?: number[] | number): void;

    function getModelNode(a: Cesium.Model, b: string | number): Cesium.ModelNode;
    function setModelRotationPosition(a: Cesium.Model, b?: number[], c?: number[]): void;
    function setNodeRotationTranslationScale(a: Cesium.ModelNode, b?: number[], c?: number[], d?: number[]): void;
    ...
    function setEntityPositionOrientation(a: Cesium.Model, b: number[], c: number[]): void;
    ...
    function setCameraPositionAndOrientation(a: Cesium.Camera, b: number[], c: number[]): void;
    ...
    class FlatRunwayTerrainProvider {
        ...
        requestTileGeometry(a: number, b: number, c: number, d: Cesium.Request): Cesium.TerrainData;
    ...
    class map {
        ...
        constructor(a: Partial<{zoom: number, holder: JQuery}>,
                    b: number,
                    c: number);
        init(): void;
        updateMap(a: number, b: number): void;
        getCenterLla(a?: number, b?: number): number[];
        addLayeredMarker(a: string, b: [string, number, number, number, number, number] & {marker: L.Marker}, c: number, d: number): void;
        getVisibleTiles(a: L.LatLngBounds, b: number): {[key in `${string}/${string}`]: true};
        showTile(a: typeof api.map.runwayLayers['major' | 'minor'], b: `${string}/${string}`): void;
        hideTile(a: typeof api.map.runwayLayers['major' | 'minor'], b: `${string}/${string}`): void;
    ...
    namespace map {
        ...
        let runwayLayers: {
            [key in 'major' | 'minor']: {
                ...
                tileSize: number;
                tiles: {
                    [key in `${string}/${string}`]: Array<[string, number, number, number, number, number] & {marker: L.CircleMarker}>;
                };
                visibileTiles: {
                    [key in `${string}/${string}`]: Array<[string, number, number, number, number, number] & {marker: L.CircleMarker}>;
                };
        ...
        function addRunwayMarker(a: typeof api.map.runwayLayers['major' | 'minor']['tiles'][`${string}/${string}`], b?: map): L.CircleMarker;
        ...
        class planeMarker {
            ...
            constructor(a: number, b: number, c: map, d?: string, e?: number, f?: string);
