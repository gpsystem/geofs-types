...
declare namespace fx {
    ...
    function init(): void;
    function update(a): void;
    function setParticlesColor(a): void;
    ...
    class Particle {
        ...
        constructor(a: Partial<typeof Particle.prototype._options>,
                    b: ParticleEmitter);
        create(): void;
    ...
    class light {
        ...
        constructor(a?: number[], b?: string, c?: ConstructorParameters<typeof api.billboard>[2]);
    ...
    let volumetricFog: {
        ...
        getColorRamp(a?: Partial<typeof fx.volumetricFog.ramp>): HTMLCanvasElement & {used?: boolean};
        create(): void;
        set(a?: number, b?: number, c?: Partial<typeof fx.volumetricFog.ramp>, d?: Cesium.Color): void;
    ...
    let cloudManager: {
        ...
        setCloudColors(a: number | null, b: number | null, c: number | null, d: number): void;
