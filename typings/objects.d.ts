...
declare namespace objects {
    ...
    let collidableObjectList: ((typeof matrix[`${number}/${number}`]['arrestingcable1' |'arrestingcable2' |'arrestingcable3' |'arrestingcable4' |'carrier' |'meigs'])[]);
    ...
    function getAltitudeAtLocation(a: number, b: number): {
        location: number[];
        normal: number[];
